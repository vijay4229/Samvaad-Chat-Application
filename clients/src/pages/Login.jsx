                ...
                <GoogleLogin
                    ...
                    render={(renderProps) => (
                        <button 
                            ...
                            className="w-full flex items-center justify-center py-3 px-4 border border-border rounded-lg text-text-primary hover:bg-bkg-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-border disabled:opacity-50 transition"
                        >
